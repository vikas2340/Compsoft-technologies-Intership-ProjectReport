...
<head>
    ...
    <link rel="stylesheet" href="login.css?v1">
...
<body>
    ...
    <div class="login__container">
        <div class="login__logo">
            <img src="logos/mainicon.png" alt="image" height="250" width="500"/>
        </div>
     ...
     <form class="login__emailPass" action="login_val.php" method="post">
...
function myFunction() {
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
                ...
                <a class="forg_pass" href="register.php">don't have an account?</a>
